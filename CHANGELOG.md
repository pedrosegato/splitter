...
All notable changes to Splitter are documented here.
...
- mDNS peer discovery on `_splitter._tcp.local.`
...
- Settings persistence in `~/.splitter/<identity>/` with hot-reload (5s mtime poll)
