...
set IDENTITY_DIR=%USERPROFILE%\.audiomirror\%PEER_NAME%
...
echo.
.\target\release\audiomirror-cli.exe daemon --signaling-port %PORT% --peer-name %PEER_NAME% --identity-dir "%IDENTITY_DIR%"
