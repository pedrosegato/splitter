...
export type SessionSnapshot = { id: SessionId; remote_peer_id: string; remote_peer_name: string; state: SessionState; streams: StreamSnapshot[] }
...
export type SourceKind = { type: "mic"; device_id: string } | { type: "system"; device_id: string }
