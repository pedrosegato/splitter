...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      {...props}
    >
      <span className="pointer-events-none absolute inset-0 hidden group-data-[variant=default]/tabs-list:group-data-[state=active]/trigger:block">
        <motion.span
